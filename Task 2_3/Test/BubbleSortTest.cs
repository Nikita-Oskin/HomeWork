...
namespace Block2_3.Tests
{
    ...
    public class BubbleSortTest
    {
        ...
        public void BubbleSortTest1()
        {
            ...
            bubble.Items.AddRange(iarray1);

            bubble.Sort();

            for(int i=0; i < iarray1.Count(); i++)
            {
                Assert.AreEqual(sortediarray1[i], bubble.Items[i]);
            }
        }
        ...
        {
            var bubble = new BubbleSort<int>();
            bubble.Items.AddRange(iarray2);

            bubble.Sort();

            for (int i = 0; i < iarray2.Count(); i++)
            {
                Assert.AreEqual(sortediarray2[i], bubble.Items[i]);
            }
        }
        ...
        {
            var bubble = new BubbleSort<int>();
            bubble.Items.AddRange(iarray3);

            bubble.Sort();

            for (int i = 0; i < iarray3.Count(); i++)
            {
                Assert.AreEqual(sortediarray3[i], bubble.Items[i]);
            }
        }
        ...
        {
            var bubble = new BubbleSort<int>();
            bubble.Items.AddRange(iarray4);

            bubble.Sort();

            for (int i = 0; i < iarray4.Count(); i++)
            {
                Assert.AreEqual(sortediarray4[i], bubble.Items[i]);
            }
        }
        ...
        {
            var bubble = new BubbleSort<string>();
            bubble.Items.AddRange(sarray1);

            bubble.Sort();

            for (int i = 0; i < sarray1.Count(); i++)
            {
                Assert.AreEqual(sortedsarray1[i], bubble.Items[i]);
            }
        }
        ...
        {
            var bubble = new BubbleSort<string>();
            bubble.Items.AddRange(sarray2);

            bubble.Sort();

            for (int i = 0; i < sarray2.Count(); i++)
            {
                Assert.AreEqual(sortedsarray2[i], bubble.Items[i]);
            }
        }
        ...
        {
            var bubble = new BubbleSort<string>();
            bubble.Items.AddRange(sarray3);

            bubble.Sort();

            for (int i = 0; i < sarray3.Count(); i++)
            {
                Assert.AreEqual(sortedsarray3[i], bubble.Items[i]);
            }
        }
        ...
        {
            var bubble = new BubbleSort<string>();
            bubble.Items.AddRange(sarray4);

            bubble.Sort();

            for (int i = 0; i < sarray4.Count(); i++)
            {
                Assert.AreEqual(sortedsarray4[i], bubble.Items[i]);
            }
        }
    }
}
